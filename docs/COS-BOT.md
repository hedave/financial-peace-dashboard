...
1. Forward the images and this instruction to the FigPig bot in one message:
   “Import these USAA checking screenshots into FigPig. Merge all images. Skip rows you cannot date or amount. Reply with applied, imported, duplicates, skipped, categorized, and 3 merchant names. Do not open a browser.”
